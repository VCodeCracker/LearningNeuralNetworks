...
import TestNetworks.CreateBinaryOfNumber2.Main;
...
public class SigmoidNetworkForHandWriting implements Serializable {
    ...
    public SigmoidNetworkForHandWriting(int... sizes) {
        this.sizes = sizes;
